...
import logo from 'figma:asset/4afcc26b61534ec4c87fd59b75e8a24ae421c1ca.png';
        ...
        <div className="text-center">
          ...
          >
            ...
            >
              ...
              />
              <motion.div 
                className="absolute -inset-4 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full blur-2xl opacity-20"
                animate={{
                  opacity: [0.2, 0.3, 0.2],
                  scale: [1, 1.1, 1],
                }}
